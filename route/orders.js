...
const stripe = require("stripe")(
  "sk_test_51NDTB0HSGwOehr5IBepmfOC2Bu1Fmz2OvKIEbbHyHwWFiKMWy2xoDi3HsNIBCv9ij0MOt0KbHXpxoxIa203zEnmm00aKhqw1BB",
);
...
router.get("/get/total_seals", async (rea, res) => {
  ...
  if (!totalSeals) {
    res.status(400).send("The order cannot be aggregate");
  }
...
router.get("/get/user_orders/:userid", async (req, res) => {
  ...
  if (!userOrderList) {
    res.status(400).send("There is no order history for this user");
  }
